...
# sync_upload.php expects cwd under $WWW/emoncms after Lib/load_emoncms.php runs; running
# php $EMONCMS_DIR/modules/sync/sync_upload.php breaks includes unless Modules/sync exists here.
WWW="${WWW:-/var/www}"
